...
for item in res3:
    G1_opt_error_GT_om_WRT_GuOptVsGest.append(item['GuOptVsGest']['G1_opt_error_GT_WRT_GuOptVsGest'][0])
    G1_opt_error_GT_com_WRT_GuOptVsGest.append(item['GuOptVsGest']['G1_opt_error_GT_WRT_GuOptVsGest'][1])

    Gu_opt_errors_network_GT_U_om_WRT_GuOptVsGest.append(item['GuOptVsGest']['Gu_opt_errors_network_GT_U_WRT_GuOptVsGest'][0])
    Gu_opt_errors_network_GT_U_com_WRT_GuOptVsGest.append(item['GuOptVsGest']['Gu_opt_errors_network_GT_U_WRT_GuOptVsGest'][1])

    Gu_opt_errors_g_estimated_om_WRT_GuOptVsGest.append(item['GuOptVsGest']['Gu_opt_errors_g_estimated_WRT_GuOptVsGest'][0])
    Gu_opt_errors_g_estimated_com_WRT_GuOptVsGest.append(item['GuOptVsGest']['Gu_opt_errors_g_estimated_WRT_GuOptVsGest'][1])

    times.append(item['general']['total_time'])
...
for item in res:
    G1_opt_error_GT_om.append(item['GuOptVsGest']['G1_opt_error_GT_WRT_GuOptVsGest'][0])
    G1_opt_error_GT_com.append(item['GuOptVsGest']['G1_opt_error_GT_WRT_GuOptVsGest'][1])

    Gu_opt_errors_network_GT_U_om.append(item['GuOptVsGest']['Gu_opt_errors_network_GT_U_WRT_GuOptVsGest'][0])
    Gu_opt_errors_network_GT_U_com.append(item['GuOptVsGest']['Gu_opt_errors_network_GT_U_WRT_GuOptVsGest'][1])

    Gu_opt_errors_g_estimated_om.append(item['GuOptVsGest']['Gu_opt_errors_g_estimated_WRT_GuOptVsGest'][0])
    Gu_opt_errors_g_estimated_com.append(item['GuOptVsGest']['Gu_opt_errors_g_estimated_WRT_GuOptVsGest'][1])
