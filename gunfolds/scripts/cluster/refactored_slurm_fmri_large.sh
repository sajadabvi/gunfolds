...
OPTIM=${OPTIM:-optN}     # 'opt' = single optimum (fast, 1 sol/subj); 'optN' = full near-optimal set
...
if [ "$METHOD" = "RASL" ]; then
    EXTRA_ARGS="$EXTRA_ARGS --MAXU 4 --PRIORITY 11112 --tol_low 5 --tol_high 5 --optim ${OPTIM}"
