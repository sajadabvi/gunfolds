...
sns.lineplot(data=normalized_times, label='normalized time', ax=axes[0])
axes[0].set_title('VAR Simulation on 8 node random graphs error for different SCC options')
...
plt.show()
# plt.savefig("simulation_results_8nodes.svg")
