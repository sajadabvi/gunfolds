...
if __name__ == '__main__':
    ...
    for item in res17:
        ErrVs.extend(['GuVsGTu', 'GuVsGest', 'G1VsGT'])
        WRT.extend(['GuOptVsGest', 'GuOptVsGest', 'GuOptVsGest'])
        Err.extend(cal_freq_error(item,err_criteria,0))
        ErrType.extend(['omm', 'omm', 'omm'])
        weights_scheme.extend(['U2_freq_error', 'U2_freq_error', 'U2_freq_error'])
        ErrVs.extend(['GuVsGTu', 'GuVsGest', 'G1VsGT'])
        WRT.extend(['GuOptVsGest', 'GuOptVsGest', 'GuOptVsGest'])
        Err.extend(cal_freq_error(item,err_criteria,1))
        ErrType.extend(['comm', 'comm', 'comm'])
        weights_scheme.extend(['U2_freq_error', 'U2_freq_error', 'U2_freq_error'])
        #################################################################################################
        # ErrVs.extend(['GuVsGTu', 'GuVsGest', 'G1VsGT'])
    ...
    for item in res18:
        ...
        Err.extend(cal_freq_error(item,err_criteria,0))
        ErrType.extend(['omm', 'omm', 'omm'])
        weights_scheme.extend(['U3_freq_error', 'U3_freq_error', 'U3_freq_error'])
        ErrVs.extend(['GuVsGTu', 'GuVsGest', 'G1VsGT'])
        WRT.extend(['GuOptVsGest', 'GuOptVsGest', 'GuOptVsGest'])
        Err.extend(cal_freq_error(item,err_criteria,1))
        ErrType.extend(['comm', 'comm', 'comm'])
    ...
    for item in res19:
        ...
        Err.extend(cal_freq_error(item,err_criteria,0))
        ErrType.extend(['omm', 'omm', 'omm'])
        weights_scheme.extend(['U4_freq_error', 'U4_freq_error', 'U4_freq_error'])
        ErrVs.extend(['GuVsGTu', 'GuVsGest', 'G1VsGT'])
        WRT.extend(['GuOptVsGest', 'GuOptVsGest', 'GuOptVsGest'])
        Err.extend(cal_freq_error(item,err_criteria,1))
        ErrType.extend(['comm', 'comm', 'comm'])
    ...
    # plt.show()
    plt.savefig("figs/old_errror_cal_VS_frequency_error_" + err_criteria + "_error.png")
